...
#you properly used the dataset that contained distinct item numbers but please be careful to distinguish between proportion and rate you produced proportion values but we are interested in rates per 1000 persons; thus you would have set it up as total no. crimes in neighborhood*1000/mean population for each neighborhood
```
#Question 7
```{r}
...
unique_pop[2, 23:24]
#correct answer was Lakewood with a total number of crimes of 10 and the population size was 13,989
```
...
#your code tell us the data structure of the above variables, but you left out other steps which led you to the correct answer
```
...
#your code yielded one mean of sepal length; please review how to write a for loop
...
#lost points for not making the color of the points different for each different number of cylinders in the engine
